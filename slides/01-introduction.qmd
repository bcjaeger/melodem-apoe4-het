...
:::footer
Each lecture is 75m and this includes time for questions/discussion.
:::

## Schedule for day 1: Afternoon

*Oblique random forests (75m)*

- Break (15m)

*Causal random forests (75m)*
...
:::footer
Each lecture includes time for questions/discussion.
:::
...
- Place **green** sticky note on the back of your laptop when you are **done**
...
Half the battle of learning is organization. We're going to get organized.
...
![](diagram/targets-vis-data_sim.svg){width=90%}
...
6. Modify the code showen here in `_targets.R`, replacing `zzzz` with the name of your data.

7. Save the `_targets.R` file

8. Run `tar_make()` in the R console. 

9. run `tar_read(data_zzzz)`, where `zzzz` is your data name.
